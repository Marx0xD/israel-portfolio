export function BackendOwnershipDiagram() {
  return (
    <div className="diagram-shell" aria-label="Backend ownership value diagram">
      <svg viewBox="0 0 760 360" role="img">
        ...
        <text x="68" y="56" fill="var(--coral-deep)" fontFamily="var(--font-technical)" fontSize="12" letterSpacing="1.2">MESSY SYMPTOMS</text>
        <rect x="58" y="86" width="154" height="38" rx="8" fill="var(--pink)" stroke="rgba(27,36,48,0.16)" />
        <text x="78" y="110" fill="var(--ink)" fontFamily="var(--font-technical)" fontSize="12" letterSpacing="1">WRONG BALANCE</text>
        <rect x="58" y="136" width="154" height="38" rx="8" fill="var(--pink)" stroke="rgba(27,36,48,0.16)" />
        <text x="78" y="160" fill="var(--ink)" fontFamily="var(--font-technical)" fontSize="12" letterSpacing="1">DUPLICATE WEBHOOK</text>
        <rect x="58" y="186" width="154" height="38" rx="8" fill="var(--pink)" stroke="rgba(27,36,48,0.16)" />
        <text x="78" y="210" fill="var(--ink)" fontFamily="var(--font-technical)" fontSize="12" letterSpacing="1">MISSING ACCESS</text>
        <rect x="58" y="236" width="154" height="38" rx="8" fill="var(--pink)" stroke="rgba(27,36,48,0.16)" />
        <text x="78" y="260" fill="var(--ink)" fontFamily="var(--font-technical)" fontSize="12" letterSpacing="1">PRODUCTION FAILURE</text>
        ...
        <text x="314" y="184" fill="var(--ink)" fontFamily="var(--font-sans)" fontSize="27" fontWeight="700">the backend</text>
        <text x="314" y="214" fill="var(--ink-soft)" fontFamily="var(--font-technical)" fontSize="12" letterSpacing="1">AUTHORITY + STATE</text>

        <text x="546" y="56" fill="var(--coral-deep)" fontFamily="var(--font-technical)" fontSize="12" letterSpacing="1.2">CONTROLLED OUTCOMES</text>
        <rect x="544" y="86" width="154" height="38" rx="8" fill="var(--sun)" stroke="rgba(27,36,48,0.16)" />
        <text x="564" y="110" fill="var(--ink)" fontFamily="var(--font-technical)" fontSize="12" letterSpacing="1">BACKEND OWNER</text>
        <rect x="544" y="136" width="154" height="38" rx="8" fill="var(--sun)" stroke="rgba(27,36,48,0.16)" />
        <text x="564" y="160" fill="var(--ink)" fontFamily="var(--font-technical)" fontSize="12" letterSpacing="1">SOURCE OF TRUTH</text>
        <rect x="544" y="186" width="154" height="38" rx="8" fill="var(--sun)" stroke="rgba(27,36,48,0.16)" />
        <text x="564" y="210" fill="var(--ink)" fontFamily="var(--font-technical)" fontSize="12" letterSpacing="1">EXPLICIT STATE</text>
        <rect x="544" y="236" width="154" height="38" rx="8" fill="var(--sun)" stroke="rgba(27,36,48,0.16)" />
        <text x="564" y="260" fill="var(--ink)" fontFamily="var(--font-technical)" fontSize="12" letterSpacing="1">EVIDENCE</text>

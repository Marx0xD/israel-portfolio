  ...
  return (
    <div className="diagram-shell" aria-label="Credit ledger backend ownership diagram">
      <svg viewBox="0 0 760 360" role="img">
        ...
        <rect x="540" y="88" width="154" height="78" rx="8" fill="var(--sun)" stroke="rgba(27,36,48,0.16)" />
        <text x="560" y="116" fill="var(--coral-deep)" fontFamily="var(--font-technical)" fontSize="11" letterSpacing="0.8">BALANCE RULES</text>
        <text x="560" y="142" fill="var(--ink)" fontFamily="var(--font-sans)" fontSize="19" fontWeight="700">Controlled</text>
        <text x="560" y="162" fill="var(--ink-soft)" fontFamily="var(--font-technical)" fontSize="11" letterSpacing="0.8">mutations</text>

        <rect x="540" y="218" width="166" height="78" rx="8" fill="var(--pink)" stroke="rgba(27,36,48,0.16)" />
        <text x="560" y="246" fill="var(--coral-deep)" fontFamily="var(--font-technical)" fontSize="10.5" letterSpacing="0.6">CONTENT OWNERSHIP</text>
        <text x="560" y="272" fill="var(--ink)" fontFamily="var(--font-sans)" fontSize="19" fontWeight="700">Access</text>
        <text x="560" y="292" fill="var(--ink-soft)" fontFamily="var(--font-technical)" fontSize="11" letterSpacing="0.8">enforced</text>
        ...
        <line x1="492" y1="130" x2="540" y2="130" stroke="var(--ink)" strokeWidth="2" markerEnd="url(#credit-arrow)" />
